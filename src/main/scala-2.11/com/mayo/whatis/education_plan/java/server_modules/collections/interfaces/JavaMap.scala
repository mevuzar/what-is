...
import com.mayo.whatis.education_plan.java.server_modules.collections.features.{DuplicateKeys, Unsupported}
...
trait JavaMap extends JavaCollectionRoot {
   override val features: scala.List[Feature] = List(Unsupported(DuplicateKeys))
