...
import com.mayo.whatis.education_plan.java.server_modules.collections.features.{DuplicateElements, Supports}
...
trait List extends JavaCollection {
   override val features: scala.List[Feature] = List(Supports(DuplicateElements))
